...
CTrackCounterDashboard dashboard;
...
int OnInit()
{
   ...
   Print("📊 Inizializzo dashboard visuale...");
dashboard.Init("TL_DASH", 10, 10); // nome+posizione
dashboard.SetDebugMode(true);     // stampa interna
dashboard.Show();
   
   
   // === [G] INIZIALIZZAZIONE PARAMETRI STRATEGICI ===
  paramsManager.Init(
   trend_period_micro_s1, trend_period_macro_s1, trend_period_extra_s1,
   trend_period_micro_s2, trend_period_macro_s2, trend_period_extra_s2,
   trend_period_micro_s3, trend_period_macro_s3, trend_period_extra_s3,
   trend_period_micro_s4, trend_period_macro_s4, trend_period_extra_s4,

   enable_s1, enable_s2, enable_s3, enable_s4,
   invert_strategy_s1, invert_strategy_s2, invert_strategy_s3, invert_strategy_s4,
   bypass_filter_s1, bypass_filter_s2, bypass_filter_s3, bypass_filter_s4,

   use_rm_s1, use_rm_s2, use_rm_s3, use_rm_s4,
   min_index_s1, min_index_s2, min_index_s3, min_index_s4,
   max_trades_s1, max_trades_s2, max_trades_s3, max_trades_s4,
   min_spacing_s1, min_spacing_s2, min_spacing_s3, min_spacing_s4,

   min_bars_micro_s1, min_bars_micro_s2, min_bars_micro_s3, min_bars_micro_s4,
   min_bars_macro_s1, min_bars_macro_s2, min_bars_macro_s3, min_bars_macro_s4,
   min_bars_extra_s1, min_bars_extra_s2, min_bars_extra_s3, min_bars_extra_s4,

   angle_thresh_extra_s1_buy, angle_thresh_macro_s1_buy, angle_thresh_micro_s1_buy,
   velocity_min_micro_s1_buy, price_dist_extra_s1_buy,
   max_positions_s1_buy, min_spacing_s1_buy, equity_tp_s1_buy,

   angle_thresh_extra_s2_buy, angle_thresh_macro_s2_buy, angle_thresh_micro_s2_buy,
   velocity_min_micro_s2_buy, price_dist_extra_s2_buy,
   max_positions_s2_buy, min_spacing_s2_buy, equity_tp_s2_buy,

   angle_thresh_extra_s3_buy, angle_thresh_macro_s3_buy, angle_thresh_micro_s3_buy,
   velocity_min_micro_s3_buy, price_dist_extra_s3_buy,
   max_positions_s3_buy, min_spacing_s3_buy, equity_tp_s3_buy,

   angle_thresh_extra_s4_buy, angle_thresh_macro_s4_buy, angle_thresh_micro_s4_buy,
   velocity_min_micro_s4_buy, price_dist_extra_s4_buy,
   max_positions_s4_buy, min_spacing_s4_buy, equity_tp_s4_buy,

   angle_thresh_extra_s1_sell, angle_thresh_macro_s1_sell, angle_thresh_micro_s1_sell,
   velocity_min_micro_s1_sell, price_dist_extra_s1_sell,
   max_positions_s1_sell, min_spacing_s1_sell, equity_tp_s1_sell,

   angle_thresh_extra_s2_sell, angle_thresh_macro_s2_sell, angle_thresh_micro_s2_sell,
   velocity_min_micro_s2_sell, price_dist_extra_s2_sell,
   max_positions_s2_sell, min_spacing_s2_sell, equity_tp_s2_sell,

   angle_thresh_extra_s3_sell, angle_thresh_macro_s3_sell, angle_thresh_micro_s3_sell,
   velocity_min_micro_s3_sell, price_dist_extra_s3_sell,
   max_positions_s3_sell, min_spacing_s3_sell, equity_tp_s3_sell,

   angle_thresh_extra_s4_sell, angle_thresh_macro_s4_sell, angle_thresh_micro_s4_sell,
   velocity_min_micro_s4_sell, price_dist_extra_s4_sell,
   max_positions_s4_sell, min_spacing_s4_sell, equity_tp_s4_sell
);
   ...
   // === DEBUG: Stampa parametri strategici iniziali ===
Print("🧠 Parametri S1:", S1Params.ToString());
Print("🧠 Parametri S2:", S2Params.ToString());
Print("✅ EA inizializzato con SUCCESSO");
